...
<div className="flex w-full flex-col justify-center gap-4 sm:flex-row sm:gap-6">
  <Link
    href="/contact-sales"
    className="inline-flex cursor-pointer items-center justify-center rounded-lg bg-[#009D8C] px-8 py-3 text-[15px] font-medium text-white shadow-[0_4px_12px_0_#009D8C4D] transition-colors hover:bg-teal-700 sm:px-12"
  >
    Contact Sales
  </Link>
  ...
  <Link
    href="/start-free"
    className="inline-flex cursor-pointer items-center justify-center rounded-lg border border-slate-200 bg-white px-8 py-3 font-medium text-slate-800 transition-colors hover:bg-slate-100 dark:border-gray-600 dark:bg-gray-800 dark:text-white dark:hover:bg-gray-700 sm:px-12"
  >
    Start Free Trial
  </Link>
</div>
