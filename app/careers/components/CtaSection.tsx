    ...
    <section className="bg-[#F1FAFA] dark:bg-slate-950 px-6 py-16 sm:py-20 md:px-12 lg:px-20 xl:px-32 transition-colors duration-300">
      <div className="mx-auto flex max-w-6xl flex-col items-center gap-8 text-center">
        ...
        <div className="mt-2 flex w-full flex-col items-center justify-center gap-4 sm:w-auto sm:flex-row">
          <button className="w-full sm:w-auto rounded-lg bg-[#009D8C] px-8 py-3 text-sm font-semibold text-white shadow-[0_4px_12px_rgba(0,157,140,0.35)] transition-all hover:bg-teal-700 cursor-pointer">
            Explore Open Roles
          </button>

          <button className="w-full sm:w-auto rounded-lg border border-[#E4EBF4] dark:border-slate-700 bg-white dark:bg-slate-900 text-[#2A3D55] dark:text-white px-8 py-3 text-sm font-semibold transition-all hover:bg-slate-100 dark:hover:bg-slate-800 cursor-pointer">
