  ...
  return (
    <section className="bg-gray-50 py-16 transition-colors dark:bg-gray-900">
      <div className="mx-auto max-w-6xl px-6">
        ...
        {/* Heading */}
        <h2 className="mt-4 text-center text-4xl font-bold text-slate-800 dark:text-white">
          Enterprise agreements and custom terms
        </h2>

        {/* Description */}
        <p className="mx-auto mt-4 max-w-3xl text-center text-base leading-7 text-gray-500 dark:text-gray-300">
