...
export default function ExportEvidenceCta() {
  return (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center p-6 sm:p-10 lg:p-12">
          ...
          <div className="flex flex-col items-start gap-4">
            ...
            <p className="text-sm sm:text-base text-slate-600 dark:text-slate-300 leading-relaxed max-w-lg">
              See how purpose limitation, pinned versions, declared gaps, redaction categories, and
              separated access states make a package defensible — and make its limits legible.
            </p>
          ...
          <div className="w-full flex justify-center lg:justify-end">
            <img
              ...
              src="/auditable-time-records-evidence-bundle/export-evidence.png"
              alt="Selected evidence items packaged for a stated purpose, with permitted destinations approved"
            />
          </div>
