 ...
 * - Tailwind CSS, dark mode via `dark:` classes
 * - Fully responsive
 */
    ...
    <div className="min-h-screen bg-white text-slate-900 dark:bg-gray-900 dark:text-white">
          ...
          <div className="mt-10 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
            ...
            {ANNOUNCEMENTS.map((item) => (
              ...
              >
                ...
                {/* Read announcement button intentionally commented out */}
                {/*
                <a
                  href="#"
          ...
          <div className="mt-10 divide-y divide-slate-200 border-y border-slate-200 dark:divide-gray-800 dark:border-gray-800">
            ...
            {PRESS_RELEASES.map((item) => (
              ...
              >
                ...
                {/* Read Release — active PRLog link */}
                <a
                  href="https://www.prlog.org/13166185-zoikotime-expands-workforce-assurance-platform-with-evidence-led-governance-communication-contex.html"
                  target="_blank"
      ...
      >
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mt-10 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
            ...
            {MEDIA_KIT_ITEMS.map((item) => (
              ...
              >
                ...
                {/* Download button intentionally commented out */}
                {/*
                <a
                  href="#"
          ...
          {/* Complete Media Kit button intentionally commented out */}
          {/*
