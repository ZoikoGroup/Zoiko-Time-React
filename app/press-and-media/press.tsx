...
const ANNOUNCEMENTS: Announcement[] = [
  {
    ...
    tag: "Product",
    tagClass:
      "bg-emerald-50 text-teal-700 dark:bg-teal-500/10 dark:text-teal-400",
    title:
      "ZoikoTime Launches ISO/IEC 42001 AI Governance Compliance Layer Across All Enterprise Plans",
    body:
      "Full alignment with the international AI management standard — embedded in ZoikoTime's governance architecture and immediately available to all enterprise clients.",
  },
  {
    date: "2026-02-28",
    tag: "Corporate",
    ...
    title:
      "ZoikoTime Expands Global Operations — 40 Jurisdictions Now Supported Natively",
    body:
      "Native policy logic for 40+ jurisdictions operational across the ZoikoTime platform — covering major labour law frameworks in Europe, the Americas, APAC, and ANZ.",
  },
  {
    date: "2026-01-15",
    tag: "Partnership",
    ...
    title:
      "ZoikoTime Achieves SOC 2 Type II and ISO 27001 Certification",
    body:
      "ZoikoTime has completed SOC 2 Type II audit and ISO 27001 certification — providing enterprise clients and procurement teams with third-party verified security assurance.",
  },
];
...
const PRESS_RELEASES: PressRelease[] = [
  {
    date: "20 March 2026",
    title:
      "ZoikoTime Introduces Real-Time Workforce Assurance Framework for Regulated Industries",
    body:
      "Enterprise-grade compliance and evidence generation capabilities extended to healthcare, financial services, and public sector organisations — providing regulator-aligned workforce governance infrastructure from day one of deployment.",
  },
  {
    date: "14 February 2026",
    title:
      "ZoikoTime Platform Processes £2.1 Billion in Controlled Financial Exposure Across Enterprise Client Base",
    body:
      "Cumulative financial exposure identified and controlled through ZoikoTime's verification and anomaly detection infrastructure across all enterprise clients — representing verified, recovered value for finance teams worldwide.",
  },
  {
    date: "08 January 2026",
    title:
      "ZoikoTime Human-in-Command AI Architecture Achieves Full EU AI Act High-Risk System Compliance",
    body:
      "ZoikoTime's tiered human oversight model, explainable AI reasoning, and continuous validation infrastructure satisfy all applicable EU AI Act requirements for high-risk AI systems deployed in workforce management contexts.",
  },
  {
    date: "15 November 2025",
    title:
      "ZoikoTime Launches Enterprise Sovereign Tier — Dedicated Infrastructure for the Most Demanding Compliance Environments",
    body:
      "A dedicated single-tenant infrastructure option for enterprises with the most exacting compliance, residency, and governance requirements — including custom SLA terms and private cloud deployment options.",
  },
  {
    date: "03 October 2025",
    title:
      "ZoikoTime Completes Series A Funding Round — Accelerating Global Enterprise Expansion",
    body:
      "ZoikoTime has completed a Series A funding round to accelerate international expansion, deepen enterprise product capabilities, and expand the platform's multi-jurisdiction compliance coverage across additional global markets.",
  },
];
...
const STATEMENTS: Statement[] = [
  {
    ...
    quote:
      "ZoikoTime is designed to support accountability and fairness — not surveillance.",
    body:
      "ZoikoTime captures verification signals — not screenshots, keystrokes, or continuous monitoring of screen content. The system verifies that the right person is working and that policy-defined conditions are met. It does not monitor what people are doing second-by-second. Sensitivity is configurable by role and risk profile.",
  },
  {
    label: "AI & Automation",
    quote:
      "ZoikoTime uses explainable AI systems with human-in-command decision models.",
    body:
      "Every AI-driven decision includes a human-readable explanation of the signals used, the policy applied, and the confidence score assigned. No automated disciplinary outcomes are produced. Humans retain decision authority at every consequential point. This is a design principle — not a product feature.",
  },
  {
    label: "Data & Privacy",
    quote:
      "ZoikoTime operates under privacy-first principles and policy-driven data collection.",
    body:
      "Data minimisation is enforced at the system architecture level — not dependent on configuration or individual discretion. Only the signals required for the stated governance purpose are collected. Purpose limitation is enforced systemically. Privacy-by-design is a foundational requirement, not an add-on.",
  },
  {
    label: "Enterprise Use",
    quote:
      "ZoikoTime is built for organisational governance, not individual monitoring.",
    body:
      "ZoikoTime's outputs are used by HR, Finance, Compliance, and executive teams to govern workforce operations — not to monitor individual workers as an end in itself. The system is governed by employer-defined policies, applied consistently across all workers, and visible to the individuals it affects through the Transparency Center.",
  },
];
...
const MEDIA_KIT_ITEMS: MediaKitItem[] = [
  {
    ...
    body:
      "Primary logo, monochrome versions, icon mark, and wordmark — in SVG, PNG, and EPS formats. Light and dark background variants included.",
  },
  {
    icon: "🖥️",
    title: "Product Visuals",
    body:
      "Dashboard screenshots, architecture diagrams, and UI illustrations — at editorial resolution for print and web use. Approved for editorial reproduction.",
  },
  {
    icon: "👤",
    title: "Executive Profiles & Bios",
    body:
      "Media-ready biographical summaries and approved headshots for Lennox McLeod (Founder & Executive Chairman) and senior leadership team members.",
  },
  {
    icon: "📐",
    title: "Brand Guidelines",
    body:
      "Colour system, typography specifications, logo usage rules, and brand tone guidelines — structured for editorial teams and agency partners.",
  },
  {
    icon: "📄",
    title: "Company Boilerplate",
    body:
      "Standard approved company descriptions in three lengths (short, standard, extended) — for press releases, editorial notes, and analyst briefings.",
  },
  {
    icon: "📊",
    title: "Platform Fact Sheet",
    body:
      "Key statistics, platform capabilities, and enterprise metrics — structured for inclusion in editorial, analyst, and investor contexts.",
  },
];
...
const ANALYST_ITEMS: AnalystItem[] = [
  {
    ...
    body:
      "Authoritative overview of ZoikoTime's capabilities, architecture, market positioning, and competitive differentiation — structured for analyst briefing sessions.",
  },
  {
    icon: "⚙️",
    title: "Governance & Compliance Model",
    body:
      "Detailed governance architecture documentation covering the five-layer control system, AI oversight model, and compliance framework alignment — for institutional due diligence.",
  },
  {
    icon: "🌍",
    title: "Enterprise Use Cases & Market Positioning",
    body:
      "Structured analysis of the four primary workforce markets ZoikoTime serves, with use case depth, measured client outcomes, and competitive displacement analysis.",
  },
  {
    icon: "💰",
    title: "Financial Impact & ROI Model",
    body:
      "ZoikoTime's financial impact model — leakage identification methodology, ROI framework, and payback period analysis across enterprise workforce contexts.",
  },
];
...
const ARCHIVE_ITEMS: ArchiveItem[] = [
  {
    date: "2025-09-12",
    title:
      "ZoikoTime Launches Contractor Revenue Assurance Module — Verified Billing Across Gig Workforces",
    tag: "Product",
    tagClass:
      "bg-emerald-50 text-teal-700 dark:bg-teal-500/10 dark:text-teal-400",
  },
  {
    date: "2025-08-04",
    title:
      "ZoikoTime Partners With Enterprise HRIS Providers — Full API Integration Available",
    tag: "Partnership",
    tagClass:
      "bg-amber-100 text-amber-800 dark:bg-amber-500/10 dark:text-amber-400",
  },
  {
    date: "2025-07-18",
    title:
      "ZoikoTime Introduces Evidence Capture for Audit-Grade Workforce Records",
    tag: "Product",
    tagClass:
      "bg-emerald-50 text-teal-700 dark:bg-teal-500/10 dark:text-teal-400",
  },
  {
    date: "2025-06-01",
    title:
      "ZoikoTime Platform Reaches 1,000 Enterprise Client Milestone",
    tag: "Corporate",
    tagClass:
      "bg-indigo-50 text-indigo-700 dark:bg-indigo-500/10 dark:text-indigo-400",
  },
  {
    date: "2025-04-22",
    title:
      "ZoikoTime Announces Multi-Jurisdiction Policy Engine — 30+ Countries at Launch",
    tag: "Product",
    tagClass:
      "bg-emerald-50 text-teal-700 dark:bg-teal-500/10 dark:text-teal-400",
  },
  ...
  return (
    <div className="min-h-screen bg-white text-slate-900 dark:bg-gray-900 dark:text-white">
      ...
      >
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-base leading-7 text-slate-500 dark:text-gray-400">
            Official announcements, media resources, and institutional
            information about ZoikoTime — a workforce assurance and
            performance intelligence platform.
          </p>

          <p className="mx-auto mt-4 max-w-lg text-sm leading-5 text-slate-400 dark:text-gray-500">
            For press inquiries, media coverage, and official company
            materials, this page provides accurate and up-to-date information.
          </p>
        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          <div className="mt-8">
            ...
            <p className="-mt-6 font-serif text-xl leading-9 text-slate-900 dark:text-gray-100 sm:text-2xl">
              ZoikoTime is not a surveillance product. It is a
              governance-driven system designed to support responsible
              workforce management.
            </p>
          </div>

          <p className="mt-8 text-base leading-6 text-slate-500 dark:text-gray-400">
            ZoikoTime is an enterprise workforce assurance and performance
            intelligence platform designed to help organisations manage
            distributed work with accuracy, accountability, and compliance.
          </p>

          <p className="mt-4 text-base leading-6 text-slate-500 dark:text-gray-400">
            Unlike traditional time-tracking tools, ZoikoTime provides
            policy-driven validation, anomaly detection, and audit-ready
            evidence — enabling organisations to reduce operational risk,
            improve performance visibility, and maintain defensible workforce
            records across every jurisdiction and employment model.
          </p>
      ...
      <section className="bg-gray-50 px-4 py-16 dark:bg-gray-800/40 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-6xl">
          <SectionHeading
            eyebrowText="Media Coverage"
            title="Media Coverage"
          />

          <div
            className={`${cardBase} mx-auto mt-10 max-w-3xl px-6 py-10 text-center`}
          >
            <p className="text-base leading-6 text-slate-500 dark:text-gray-400">
              Media coverage will be featured here as ZoikoTime expands its
              public presence and media relationships.
            </p>

            <p className="mt-5 text-xs leading-5 text-slate-400 dark:text-gray-500">
              For editorial enquiries, interview requests, or media briefings,
              contact
      ...
      <section className="px-4 py-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-5xl">
          <SectionHeading
            eyebrowText="Leadership"
            title="Leadership for Media"
          />
          ...
          <div className={`${cardBase} mt-10 p-6 shadow-md sm:p-9`}>
            <div className="flex flex-col gap-5 sm:flex-row sm:items-start">
              ...
              <div>
                ...
                <p className="mt-1 text-xs font-semibold text-teal-600 dark:text-teal-400">
                  Founder &amp; Executive Chairman — ZoikoTime® | Zoiko Group
                  Inc.
                </p>
              </div>
            </div>
            ...
            <p className="mt-6 text-sm leading-6 text-slate-500 dark:text-gray-400">
              ...
              Group Inc. and the architect of ZoikoTime — a workforce
              assurance and performance intelligence platform built to address
              the governance, compliance, and financial risk gaps in
              enterprise workforce management. With a background spanning
              brand development, enterprise technology, and Caribbean and
              global market operations, McLeod has led the development of
              multiple brands across the Zoiko Group portfolio, with ZoikoTime
              representing the group's flagship enterprise SaaS platform.
              McLeod's core focus is on building governance-grade systems that
              help organisations operate with certainty — verified,
              defensible, and explainable — in an era when distributed and
              flexible workforce models have outpaced the governance
              infrastructure designed to manage them.
            </p>
            ...
            <div className="mt-6 rounded-r-md border-l-[3px] border-teal-600 bg-gray-50 p-5 dark:border-teal-500 dark:bg-gray-900">
              <p className="font-serif text-sm leading-6 text-slate-900 dark:text-gray-100">
                &ldquo;The gap between what organisations record and what they
                can actually prove has become a financial, legal, and
                compliance liability at scale. ZoikoTime exists to close that
                gap — with verified evidence, not assumptions.&rdquo;
              </p>
            </div>
        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mt-8 rounded-xl border border-slate-200 bg-gray-50 px-6 py-8 text-center dark:border-gray-700 dark:bg-gray-800">
            <p className="text-sm leading-6 text-slate-500 dark:text-gray-400">
              For custom briefing sessions, structured analyst calls, or
            ...
            <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
              ...
              <div>
                ...
                <p className="mt-4 text-sm leading-6 text-slate-500 dark:text-gray-400">
                  For media enquiries, interview requests, editorial
                  fact-checking, and official statements — the ZoikoTime press
                  team aims to respond to all media enquiries within one
                  business day.
                </p>
              ...
              <div>
                ...
                <ul className="mt-4 space-y-3">
                  {CONTACT_ITEMS.map((item) => (
                    <li
                      key={item}
                      className="flex gap-2 text-xs leading-5 text-slate-500 dark:text-gray-400"
                    >
      ...
      <section className="relative overflow-hidden border-t-[3px] border-teal-600 bg-teal-50 px-4 py-20 text-center dark:border-teal-500 dark:bg-teal-500/10 sm:px-6 lg:px-8">
        ...
        <p className="mx-auto mt-5 max-w-xl text-base leading-7 text-slate-500 dark:text-gray-400">
          Everything you need to report on, brief about, or partner with
          ZoikoTime — available through one press contact and one media kit
          download.
        </p>
        ...
        <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
          ...
          <Link
            href="/contact"
            className="w-full rounded-md border border-teal-600 px-8 py-3 text-sm font-medium text-teal-600 hover:bg-teal-100 dark:text-teal-400 dark:hover:bg-teal-500/10 sm:w-auto"
          >
            Request Briefing
          </Link>
        </div>
