...
export default function RecordingTimeDocPage() {
  return (
    <div className="min-h-screen bg-white dark:bg-slate-900 text-slate-800 dark:text-slate-100 font-sans transition-colors duration-200">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex flex-col md:flex-row gap-8 lg:gap-12">
          ...
          <aside className="w-full md:w-64 shrink-0 border-r-0 md:border-r border-slate-200 dark:border-slate-800 pr-0 md:pr-6">
            <nav className="space-y-6 text-sm">
              ...
              {/* Time Tracking (Active Section) */}
              <div className="space-y-1">
                <h5 className="px-2.5 text-xs font-bold text-gray-500 dark:text-slate-400 uppercase tracking-wider">Time Tracking</h5>
                <a href="#" className="block px-2.5 py-2 bg-emerald-50 dark:bg-emerald-950/50 text-teal-700 dark:text-teal-300 font-semibold rounded-md">Recording time</a>
          ...
          <main className="flex-1 max-w-4xl space-y-8">
            ...
            <div>
              ...
              <p className="text-base text-gray-500 dark:text-slate-400">
                How workers capture time events across desktop, mobile, and kiosk sources.
              </p>
            ...
            <section className="space-y-8">
              <div className="space-y-2">
                <h3 className="text-lg font-bold text-slate-800 dark:text-slate-100">Supported actions</h3>
                <p className="text-sm text-gray-700 dark:text-slate-300 leading-relaxed">
                  Start, stop, pause, resume, add a break, switch project or task context, and add a note — all available from the same interface across supported devices.
                </p>
              </div>

              <div className="space-y-2">
                <h3 className="text-lg font-bold text-slate-800 dark:text-slate-100">Source behavior</h3>
                <p className="text-sm text-gray-700 dark:text-slate-300 leading-relaxed">
                  Each capture source (desktop, mobile, kiosk, integration) preserves its own timestamp and connectivity state. Offline captures on mobile show a pending-sync indicator until they reach the server.
                </p>
              </div>

              <div className="space-y-2">
                <h3 className="text-lg font-bold text-slate-800 dark:text-slate-100">What is never captured</h3>
                <p className="text-sm text-gray-700 dark:text-slate-300 leading-relaxed">
                  No screenshots, keystroke content, URL history, application names, or clipboard data are collected by any capture source, under any configuration.
                </p>
              </div>
            </section>
            ...
            <div className="pt-6 border-t border-slate-200 dark:border-slate-800 grid grid-cols-1 sm:grid-cols-2 gap-4">
              <a href="#" className="p-4 rounded-xl border border-slate-200 dark:border-slate-800 hover:border-teal-500 dark:hover:border-teal-500 shadow-sm transition-colors group">
                ...
                <span className="text-sm font-semibold text-slate-800 dark:text-slate-100 group-hover:text-teal-600 transition-colors">Quickstart</span>
              </a>
              ...
              <a href="#" className="p-4 rounded-xl border border-slate-200 dark:border-slate-800 hover:border-teal-500 dark:hover:border-teal-500 shadow-sm transition-colors text-right group">
                ...
                <span className="text-sm font-semibold text-slate-800 dark:text-slate-100 group-hover:text-teal-600 transition-colors">Break &amp; rest configuration</span>
              </a>
            </div>
        ...
        {/* Legal & Educational Disclaimer Banner */}
