  ...
  return (
    <section className="mx-auto max-w-[696px] border-b-2 border-slate-200 dark:border-slate-700 pb-10 md:pb-12">
      <div className="flex flex-col items-center px-4 text-center sm:px-6 lg:px-0">
        {/* Title */}
        <h1 className="font-['Plus_Jakarta_Sans'] text-3xl font-extrabold leading-tight text-slate-900 dark:text-white md:text-4xl">
          Service Level Agreement
        </h1>

        {/* Description */}
        <p className="mt-6 max-w-[696px] font-['Plus_Jakarta_Sans'] text-base font-normal leading-7 text-slate-500 dark:text-slate-400">
        ...
        <div className="mt-8 inline-flex items-center justify-center rounded-full border border-teal-600/20 bg-emerald-50 px-5 py-2 dark:bg-emerald-900/20">
          <span className="font-['Plus_Jakarta_Sans'] text-xs font-bold leading-5 text-teal-700 dark:text-teal-400">
