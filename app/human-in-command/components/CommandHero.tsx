        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          <div className="flex flex-col">
            ...
            <h1 className="mt-5 max-w-[600px] text-4xl font-extrabold leading-[1.1] text-sky-950 dark:text-white sm:text-5xl lg:text-6xl">
              ...
              <span className="text-emerald-500">consequential decisions</span>
            </h1>

            {/* Subheading */}
            <p className="mt-6 max-w-[590px] text-base font-normal leading-7 text-zinc-700 dark:text-slate-300">
              Automation assists — it calculates, classifies, routes,
              summarizes, and flags. An authorized person reviews the evidence,
              can disagree with it, and owns the outcome. The affected worker
              can understand it, correct it, challenge it, escalate it, and see
              its history.
            </p>
            ...
            <div className="mt-7 flex flex-col gap-3.5 sm:flex-row sm:flex-wrap">
              ...
              >
                Explore Review Rights
              </Link>

              <Link
                href="#control-evidence"
          ...
          <div className="flex flex-col gap-1">
            ...
            <Image
              ...
              alt="An authorized reviewer weighing the evidence behind a consequential decision before owning the outcome"
              width={598}
              height={548}
              priority
            ...
            <div className="rounded-xl border border-l-[3px] border-sky-800 bg-white px-5 pb-5 pt-4 dark:bg-slate-900">
              ...
              <p className="mt-1.5 text-sm font-normal leading-6 text-zinc-700 dark:text-slate-300">
                Not &quot;human in the loop&quot; as a slogan. Not that every
                product action requires manual review. And not that human review
                guarantees a correct, fair, or lawful result — it guarantees an
                accountable one.
              </p>
