...
export default function PrivacyBoundary() {
  ...
  return (
    <section className="relative w-full overflow-hidden bg-slate-950 px-5 py-16 text-white sm:px-8 lg:min-h-[777px] lg:px-10 lg:py-[74px]">
      {/* Header */}
      ...
      {/* Comparison Card */}
      <div className="mx-auto mt-16 grid max-w-[920px] overflow-hidden rounded-2xl border border-slate-700 bg-slate-900 shadow-[0px_6px_18px_rgba(0,0,0,0.25)] lg:mt-[76px] lg:grid-cols-2">
        {/* ZoikoTime Records */}
        <div className="min-w-0">
          <div className="flex h-14 items-center bg-teal-600 px-5">
          ...
          <div className="bg-slate-900">
            {records.map((item, index) => (
              <div
                key={item}
                className={`flex min-h-[45px] items-center gap-3 px-5 ${
        ...
        {/* Never Captures */}
        <div className="min-w-0 border-t border-slate-700 lg:border-l lg:border-t-0">
          <div className="flex h-14 items-center bg-slate-800 px-5">
            <h3 className="text-base font-bold leading-6 text-white">
          ...
          <div className="bg-slate-900">
            {neverCaptures.map((item, index) => (
              ...
              >
                ...
                <span className="text-sm font-normal leading-6 text-slate-400">
                  {item}
                </span>
              </div>
            ))}
