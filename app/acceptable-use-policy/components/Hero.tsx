  ...
  return (
    <section className="border-b border-slate-200 dark:border-slate-800">
      <div className="mx-auto max-w-[696px] px-5 py-16 sm:px-6 lg:py-20">
        {/* Title */}
        <h1 className="text-center text-4xl font-extrabold leading-10 text-slate-900 dark:text-white">
          Acceptable Use Policy
        </h1>

        {/* Description */}
        <p className="mt-6 text-center text-base leading-7 text-slate-500 dark:text-slate-400">
