 ...
 * PDF DOCUMENTS
 *
 * Place these four files inside:
 *
 * public/compliance/
 *
 * compliance-overview.pdf
 * control-mapping-document.pdf
 * audit-pack.pdf
 * policy-framework-guide.pdf
 */
const documents = [
  {
    icon: "📊",
    ...
    href: "/compliance/compliance-overview.pdf",
  },
  {
    icon: "📋",
    ...
    href: "/compliance/control-mapping-document.pdf",
  },
  {
    icon: "📂",
    title: "Audit Pack",
    ...
    href: "/compliance/audit-pack.pdf",
  },
  {
    icon: "⚙️",
    ...
    href: "/compliance/policy-framework-guide.pdf",
  },
];
        ...
        <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-7xl text-center">
            ...
            <p className="mx-auto mt-8 max-w-3xl text-base leading-8 text-slate-500 dark:text-gray-300">
              ZoikoTime enables organisations to operate with confidence
              through policy-driven controls, structured evidence generation,
              and alignment with global regulatory frameworks.
            </p>
          </div>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="mt-6 text-base leading-8 text-slate-500 dark:text-gray-300">
              Compliance is enforced at the point of operation — not
              reconstructed after the fact. Every stage generates structured,
              auditable evidence automatically.
            </p>
          </div>
      ...
      <section className="bg-white py-16 lg:py-20 dark:bg-gray-950">
        <div className="mx-auto max-w-5xl px-6 text-center">
          ...
          <p className="mx-auto mt-6 max-w-3xl text-base leading-8 text-slate-500 dark:text-gray-300">
            Big 4 audit-level control documentation — click any row to expand
            the full control logic, system behaviour, and evidence generated for
            each mapped control.
          </p>
        </div>

        <div className="mx-auto mt-5 max-w-7xl px-6 lg:px-20">
          <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-lg dark:border-gray-800 dark:bg-gray-900">
            ...
            {/* Header */}
            <div className="hidden border-b border-slate-200 bg-slate-100 dark:border-gray-800 dark:bg-gray-900 md:grid md:grid-cols-[2fr_1fr_1fr_1fr_3fr]">
            ...
            {controlMappings.map((item, index) => (
              ...
              >
                ...
                {/* Desktop */}
                <div className="hidden items-center text-sm font-semibold text-slate-900 dark:text-white md:flex">
                  {item.domain}
                </div>
                ...
                <div className="hidden items-center text-sm text-slate-500 dark:text-gray-400 md:flex">
                  {item.implementation}
                </div>
              </div>
            ))}
        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="mt-6 text-base leading-8 text-slate-500 dark:text-gray-300">
              ...
              manual adherence, individual discretion, or periodic review. Here
              is the enforcement logic for the three primary control areas.
            </p>
          </div>
      ...
      <section className="bg-white py-16 lg:py-24 dark:bg-gray-950">
        <div className="mx-auto max-w-7xl px-6">
          <div className="mx-auto max-w-5xl text-center">
            ...
            <p className="mt-6 text-base leading-8 text-slate-500 dark:text-gray-300">
              Every action in ZoikoTime is linked to a structured evidence
              record timestamped, policy-referenced, integrity-signed, and
              traceable. This is the schema of a standard session evidence
              record.
            </p>
          </div>
          ...
          <div className="mx-auto mt-14 max-w-6xl overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-lg dark:border-gray-700 dark:bg-gray-900">
            ...
            <div className="overflow-x-auto bg-slate-50 p-6 font-mono text-xs leading-8 dark:bg-gray-950">
              <pre className="whitespace-pre-wrap text-xs leading-8">
            ...
            <div className="border-t border-teal-600/10 bg-emerald-50 px-6 py-4 dark:bg-emerald-900/20">
              <p className="text-center text-sm font-bold text-teal-700 dark:text-teal-400">
                Every action is linked to evidence — and every piece of
                evidence is traceable, timestamped, and integrity-verified.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="mt-16 grid gap-10 lg:grid-cols-2">
            ...
            <div>
              ...
              <p className="mt-6 text-xs leading-6 text-slate-500 dark:text-gray-400">
                ...
                no manual preparation, no reconstruction from incomplete
                records, no gaps.
              </p>
            </div>
            ...
            <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-lg dark:border-gray-700 dark:bg-gray-800">
              ...
              {auditItems.map((item, index) => (
                <div
                  key={index}
                  className="flex items-center justify-between border-b border-slate-200 px-5 py-4 dark:border-gray-700"
                >
                  <p className="max-w-sm text-xs font-semibold leading-5 text-slate-900 dark:text-white">
                    {item.title}
                  </p>

                  <span className="ml-4 shrink-0 rounded-full border border-teal-200 bg-emerald-50 px-3 py-1 text-xs font-bold text-teal-700 dark:border-teal-800 dark:bg-emerald-900/20 dark:text-teal-300">
                    Ready
                  </span>
                </div>
              ))}
            ...
            {documents.map((doc, index) => (
              ...
              >
                ...
                <a
                  ...
                  className="mt-8 text-center text-sm font-bold text-teal-600 transition hover:text-teal-700 dark:text-teal-400 dark:hover:text-teal-300"
                >
                  Download
                </a>
        ...
        <div className="mx-auto max-w-7xl px-6 py-20 lg:py-24">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="mx-auto mt-8 max-w-4xl text-base leading-8 text-slate-500 dark:text-gray-300">
              ZoikoTime provides the control framework, evidence
              infrastructure, and audit documentation that regulators,
              auditors, and legal teams require—not a compliance statement, a
              verifiable system.
            </p>
          </div>
          ...
          <div className="mt-12 flex flex-col items-center justify-center gap-5 sm:flex-row">
            <Link
              href="/request-a-demo"
              className="inline-flex items-center justify-center rounded-md bg-teal-600 px-8 py-3 text-base font-semibold text-white shadow-[0px_4px_14px_rgba(0,157,140,0.28)] transition-all duration-300 hover:bg-teal-700 hover:shadow-lg"
            >
            ...
            <Link
              href="/contact-sales"
              className="inline-flex items-center justify-center rounded-md border border-slate-300 bg-white px-8 py-3 text-base font-medium text-slate-700 transition-all duration-300 hover:bg-slate-50 dark:border-gray-700 dark:bg-gray-800 dark:text-white dark:hover:bg-gray-700"
            >
