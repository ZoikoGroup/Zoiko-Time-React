...
const plans = [
  ...
  },
  {
    ...
    features: ["Attendance & break controls", "Project time tracking", "Integrations"],
    cta: "Start Free",
    style: "default",
  },
  {
    ...
    features: ["Policy controls", "Advanced reporting", "Priority support"],
    cta: "Start Free",
    style: "highlight",
    badge: "Most Popular",
  },
          ...
          {plans.map((plan) => {
            ...
            return (
              ...
              >
                ...
                <button
                  className={[
                    "mt-auto rounded-lg py-3 text-base font-bold transition-colors",
                    isHighlight
        ...
        <div className="flex w-full max-w-xl flex-col gap-3">
          {guarantees.map((item) => (
            <div key={item} className="flex items-center gap-3">
              <CheckCircle2 className="size-3.5 text-emerald-500 dark:text-emerald-400" strokeWidth={3} />
              <span className="text-sm text-zinc-700 dark:text-gray-300">{item}</span>
            </div>
          ))}
        </div>
