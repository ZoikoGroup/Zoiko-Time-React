...
export default function ProcessingScope() {
  const processedData = [
    ...
    {
      title: "Application Usage & Input Telemetry",
      description:
        "Application usage telemetry, active window titles, and keystroke frequency metrics (excluding keylogging content) generated by the desktop client.",
    },
    {
      title: "Desktop Screen Captures",
      optional: true,
      description:
        "Periodic desktop screen captures, including redacted visual proof of work — collected only when enabled by customer policy and subject to automated masking and redaction controls.",
    },
  ];
  ...
  const purposes = [
    ...
    },
    {
      ...
      description:
        "Aggregated workforce performance signals used to generate management intelligence — processed at population level for management reporting.",
    },
    {
      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="mt-8 rounded-xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-700 dark:bg-slate-800">
          <h3 className="mb-3 text-lg font-bold text-slate-900 dark:text-white">
            Annex 1 — Details of Processing: Categories of Data
          </h3>

          <p className="text-sm leading-6 text-slate-600 dark:text-slate-300">
            Categories of personal data processed under this DPA include: User
            account identification, time entry timestamps, application usage
            telemetry, keystroke frequency metrics (excluding keylogging
            content), and periodic desktop screen captures (including redacted
