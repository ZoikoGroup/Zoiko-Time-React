    ...
    <section className="bg-gray-50 py-16 dark:bg-slate-950">
      <div className="mx-auto max-w-7xl px-5 lg:px-8">
        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h2 className="mt-3 text-3xl font-bold text-slate-800 md:text-4xl dark:text-white">
        ...
        <div className="mt-14 hidden overflow-hidden rounded-2xl border border-slate-200 bg-white shadow lg:block dark:border-slate-700 dark:bg-slate-900">
        ...
        <p className="mx-auto mt-12 max-w-2xl text-center text-base leading-7 text-gray-500 dark:text-gray-400">
...
export default SecurityDataProtected;