      ...
      <div className="mx-auto max-w-[1200px]">
        ...
        <div className="mt-14 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
          {outcomeFeatures.map((feature) => (
            <article
              key={feature.title}
              className="rounded-2xl border border-slate-800 bg-slate-900 p-8 text-center shadow-xl transition-all duration-300 hover:border-teal-500/40"
            >
              {/* Icon */}
              <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-xl border border-teal-500/20 bg-teal-950 text-2xl">
                {feature.icon}
              </div>
        ...
        {/* Feedback Loop */}
        <div className="mt-8 rounded-2xl border border-slate-800 bg-gradient-to-br from-teal-950/60 to-indigo-950/60 px-6 py-10 text-center sm:px-10">
