      ...
      <div className="mx-auto max-w-[1200px]">
        ...
        <div className="mt-14 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
          {impactCards.map((card) => (
            <article
              key={card.role}
              className="relative overflow-hidden rounded-2xl border border-slate-800 bg-slate-900 px-6 pb-8 pt-10 text-center shadow-xl transition-all duration-300 hover:border-teal-500/40"
            >
              {/* Top Accent */}
              ...
              {/* Title */}
              <h3 className="mt-6 text-xl font-bold leading-6 text-white">
                {card.title}
              </h3>
