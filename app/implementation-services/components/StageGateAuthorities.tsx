      ...
      <div className="max-w-[1180px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-start">
        ...
        <div className="lg:col-span-5 flex flex-col gap-6">
          ...
          <div className="flex flex-col sm:flex-row lg:flex-col gap-3">
            <div className="px-5 py-3.5 bg-white dark:bg-slate-800 rounded-lg border border-slate-200 dark:border-slate-700/80 shadow-sm text-slate-900 dark:text-white font-bold text-sm">
