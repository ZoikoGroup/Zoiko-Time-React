        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          <div className="flex flex-col">
            ...
            <h1 className="mt-5 max-w-[600px] text-4xl font-extrabold leading-[1.1] text-sky-950 dark:text-white sm:text-5xl lg:text-6xl">
              Know where data is handled — and what each location{" "}
              <span className="text-emerald-500">actually means</span>
            </h1>

            {/* Subheading */}
            <p className="mt-6 max-w-[645px] text-base font-normal leading-7 text-zinc-700 dark:text-slate-300">
              Storage, processing, replicas, backups, access, transfers,
              failover, and exports are separate concepts with separate
              evidence. Each carries its scope, status, effective date,
              limitations, and owner. None of them proves the others.
            </p>
          ...
          <div className="flex flex-col gap-1">
            ...
            <Image
              src="/data-location-residency/hero.png"
              alt="A governance lead reviewing storage, processing, access, and transfer locations across a global data map"
              width={598}
              height={472}
              priority
            ...
            <div className="rounded-xl border border-l-[3px] border-sky-800 bg-white px-5 pb-4 pt-4 dark:bg-slate-900">
              ...
              <p className="mt-1.5 text-sm font-normal leading-6 text-zinc-700 dark:text-slate-300">
                A map pin is not a residency guarantee. A location claim must
                explain what data, why it is there, who can access it, what
                copies and exceptional paths exist, and how the statement is
                verified.
              </p>
