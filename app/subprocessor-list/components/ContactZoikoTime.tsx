  ...
  return (
    <section className="py-12 md:py-14">
      <div className="mx-auto max-w-[696px] px-5 sm:px-6 lg:px-0">
        <div className="rounded-xl border border-slate-200 bg-gray-50 px-6 py-7 dark:border-slate-700 dark:bg-slate-900">
          {/* Heading */}
          <h3 className="text-center text-lg font-bold leading-8 text-slate-900 dark:text-white">
            Contact ZoikoTime
          </h3>
          ...
          <div className="mt-5 text-center text-sm leading-6 text-slate-500 dark:text-slate-400">
            ...
            <span>
              European HQ: 67-69 Great Portland Street, 5th Floor,
              London W1W 5PF, UK
            </span>
          </div>
        </div>
